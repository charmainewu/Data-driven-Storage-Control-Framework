# -*- coding: utf-8 -*-
"""
Created on Mon Mar  2 13:47:21 2020
...
r = scaler_r.fit_transform(load_data)
...
for n_outputs in range(5):
    ...
    model.save_weights("./loaddata/s2s"+str(n_outputs)+".h5")
...
np.save("./loaddata/s2smae.npy",mae)
np.save("./loaddata/s2srmse.npy",rmse)